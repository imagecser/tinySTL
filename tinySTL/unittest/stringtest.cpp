...
namespace sz {
    namespace stringTest {
        ...
        void construct() {
            ...
            unittest(st6, sz6, "string(InIt first, InIt last);");
        ...
        void append() {
            ...
            unittest(s1, z1, "string& append(InIt first, InIt last);", false);
            z1.append(s1.begin(), s1.end());
            s1.append(s1.begin(), s1.end());
            unittest(s1, z1, "string& append(InIt first, InIt last);");
        ...
        void replace() {
            ...
            unittest(s1, s2, "string& replace(iterator first, iterator last, InIt inputfirst, InIt inputlast);");
        }
